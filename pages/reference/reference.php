        ...
        <div class="content-wrapper">
          ...
          <div class="content-header">
            <div class="container-fluid">
              <div class="row mb-2">
                <div class="col-sm-6">
                  <h1 class="m-0">Manage Reference</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                  <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Manage Reference</li>
                  </ol>
                </div><!-- /.col -->
              </div><!-- /.row -->
            </div><!-- /.container-fluid -->
                ...
                <div class="col-12 col-sm-12">
                  ...
                  <div class="card card-primary card-outline">
                    <div class="card-body table-responsive">
                      <form method="post">
                        <table id="tblreference" class="table table-bordered table-striped table-hover">
                          <thead>
                            <tr>
                              ...
                              <th class="align-middle">Reference Name</th>
                              <th class="align-middle" width="175px">Created</th>
                              <th class="align-middle" width="220px">Added By</th>
                              <th class="align-middle" width="105px">Option</th>
                            </tr>
                          </thead>
                          <tbody>
                            <?php
                            $squery = mysqli_query($con, "SELECT * FROM tbladdreference");
                            while ($row = mysqli_fetch_array($squery)) {
                              ...
                              echo '
                                <tr>
                                    ...
                                    <td class="align-middle">' . $row['ref_name'] . '</td>
