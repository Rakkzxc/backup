...
if (!isset($_SESSION['role'])) {
  ...
  <body>
    ...
    <div style="margin: 55px 100px 0;" class="clearance_container">
      ...
      <br>
      <br>
      <h1 class="text-center text-uppercase text-bold">barangay permit</h1>
      <br>
      <br>
      ...
      <div class="text-content"
        ...
        $qry = mysqli_query($con, "SELECT * from tblresident r left join tblpermit c on c.residentid = r.id where residentid = '" . $_GET['resident'] . "' and permitNo = '" . $_GET['permit'] . "' ");
      ...
      <button class="noprint" id="printpagebutton"
        ...
        onclick="PrintElem('#permit')">Print</button>
    </div>
  </body>
  <?php
} ?>
