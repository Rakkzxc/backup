...
include "../../include/session/resident.session.inc.php";
...
if (isset($_POST['btn_login'])) {
  ...
  $stmt = mysqli_prepare($con, "SELECT id, fname, lname, image, username FROM tblresident WHERE username = ? AND password = ?");
