            ...
            <div class="container-fluid">
              <div class="col-md-6 col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <input name="txt_edit_igpit" class="form-control input-sm" type="number" value="' . $erow['igpitID'] . '"
                    min="1" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select name="ddl_edit_los" class="form-control input-sm">
                    <option value="' . $erow['landOwnershipStatus'] . '">
                      ' . $erow['landOwnershipStatus'] . '</option>
                    <option>Owned</option>
              ...
              <div class="col-md-6 col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <input name="txt_edit_purok" class="form-control input-sm" type="text" value="' . $erow['purok'] . '" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select name="ddl_edit_hos" class="form-control input-sm">
                    <option value="' . $erow['houseOwnershipStatus'] . '" selected>
                      ' . $erow['houseOwnershipStatus'] . '</option>
