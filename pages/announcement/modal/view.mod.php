<?php echo '
<div id="viewModal' . $row['id'] . '" class="modal fade">
  <form method="post" enctype="multipart/form-data">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title">View Photo for Announcement ' . $row['announcement'] . '</h4>
        </div>
        <div class="modal-body">
          <input type="hidden" name="hidden_id" value="' . $row['id'] . '">
          <input type="checkbox" id="cbxMainphoto" /><label> Select All</label>
          <div class="row">';
          $p = mysqli_query($con, "SELECT * from tblannouncementphoto where announcementid = '" . $row['id'] . "' ");
        ...
        <div class="modal-footer">
          <div class="col-md-6"><input name="photos[]" class="form-control input-sm" type="file" multiple />
          </div>
